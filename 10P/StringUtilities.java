...
{  
    ...
    private static String randorder;
    ...
    public static ArrayList< String > getQuotes( )
    {
        ...
        String quote2 = "Efforts and courage are not enough" 
            + "without purpose and dedication "
            + "( JFK )";
        quotes.add( quote2 );
        ...
        String quote4 = "If you take shortcuts, you get cut short" 
            + "( Gary Busey )";
        quotes.add( quote4 );
        ...
        String quote6 = "If a nation loses its storytellers, it loses its "
            + "childhood "
            + " ( Peter Handke )" ;
        quotes.add( quote6 );
        return quotes;
